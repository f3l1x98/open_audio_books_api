...
public class RemoveGenreCommandHandlerTests {

    private RemoveGenreCommandHandler commandHandler;
    ...
    @BeforeEach
    public void init() {
        commandHandler = new RemoveGenreCommandHandler(genreRepository, audioBookRepository);
    }
    ...
    @Test
    public void testHandle_success_genreNotAssigned() {
        Genre mockGenre = new Genre("Mock genre");
        AudioBook mockAudioBook = new AudioBook(
                "Mock title",
                "Mock summary",
