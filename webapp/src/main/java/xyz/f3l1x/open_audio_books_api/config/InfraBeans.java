...
@EnableFilesystemStores(basePackages = "xyz.f3l1x.infra")
...
class InfraBeans {
    ...
    @Bean
    public IEpisodeStore episodeStore(ModelMapper modelMapper, IEpisodeContentStore episodeContentStore) {
        return new EpisodeContentStore(modelMapper, episodeContentStore);
    }
}
